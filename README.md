...
- Golang
  ...
  - [ ] Goプログラミング実践入門 標準ライブラリでゼロからWebアプリを作る
    - [x] 第1章 Go言語はWebアプリ開発に最適な言語
    - [x] 第2章 Goプログラム「ChitChat」――典型的なGo Webアプリのデザイン
    - [x] 第3章 net/httpライブラリを使ったリクエストの受け付け
    - [x] 第4章 リクエストのデータ構造とその処理
    - [x] 第5章 テンプレートエンジンを使ったコンテンツの表示
  ...
  - [ ] みんなのGo言語
    - [x] 第1章 Goによるチーム開発のはじめ方とコードを書く上での心得
    - [x] 第2章 マルチプラットフォームで動作する社内ツールのつくり方
    - [x] 第3章 実用的なアプリケーションを作るために
    - [x] 第4章 コマンドラインツールを作る
    - [x] 第5章 The Dark Arts Of Reflection
    - [x] 第6章 Goのテストに関するツールセット
    - [ ] 第7章 データベースの扱い方
  - [ ] はじめての「Go言語」
  - [ ] Goで作るインタプリタ
- Rust
